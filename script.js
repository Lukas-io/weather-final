...
const hail = "img/hail.svg";
const rainy = "img/rainy.svg";
const snow = "img/snow.svg";
const strong_rain = "img/strong-rain.svg";
const sunny_cloud = "img/sunny-cloud.svg";
const sunny_rain = "img/sunny-rain.svg";
const thunderstorm = "img/thunderstorm.svg";
const night_clear_cloud = "img/night-clear-cloud.svg";
const night_clear = "img/night-clear.svg";
const night_cloud = "img/night-cloud.svg";
const night_rain = "img/night-rain.svg";
...
function createListItem(
  ...
  humidityIcon.src = "img/iwwa_humidity.svg";
